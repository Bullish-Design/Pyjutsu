...
class PyRepoView:
    ...
    def evolution(self, change_id_str: str, limit: int | None = ...) -> list[dict[str, object]]: ...
    def bookmarks(self) -> list[dict[str, object]]: ...
    def conflicts(self, revset_str: str) -> list[dict[str, object]]: ...
    def conflict_content(self, path: str, revset_str: str, style: str) -> str: ...
    def conflict_sides(self, path: str, revset_str: str) -> list[str]: ...
    def file_content(self, path: str, revset_str: str) -> bytes: ...
    def verify(self, revset_str: str) -> dict[str, object] | None: ...
    def file_list(self, revset_str: str, paths: list[str] | None = ...) -> list[str]: ...
    def diff_stat(self, revset_str: str) -> dict[str, object]: ...
    def diff_stat_between(self, from_str: str, to_str: str) -> dict[str, object]: ...
    def diff(self, revset_str: str) -> dict[str, object]: ...
    def diff_between(self, from_str: str, to_str: str) -> dict[str, object]: ...
    def is_ancestor(self, ancestor: str, descendant: str) -> bool: ...
    def patch_id(self, revset_str: str) -> str: ...
...
class PyWorkspace:
    ...
    @staticmethod
    def load(
        path: str | os.PathLike[str], sign_behavior: str | None = ...
    ) -> PyWorkspace: ...
    @staticmethod
    def init(
    ...
    def gc(self, keep_newer_epoch: float) -> None: ...
    ...
    def create_tag(
        self, name: str, target: str, message: str | None = ..., force: bool = ...
    ) -> dict[str, object] | None: ...
    def push_tag(self, name: str, remote: str) -> dict[str, object] | None: ...
    def git_tag(self, name: str) -> dict[str, object] | None: ...
    def git_tags(self) -> list[dict[str, object]]: ...
    def git_config_get(self, key: str) -> str | None: ...
    def git_config_set(self, key: str, value: str) -> None: ...
    def git_config_unset(self, key: str) -> None: ...
    def git_head(self) -> dict[str, object]: ...
    def git_set_head(self, name: str) -> None: ...
    def git_worktrees(self) -> list[dict[str, object]]: ...
    def git_object_type(self, oid: str) -> str | None: ...
    def git_object_exists(self, oid: str) -> bool: ...
    def git_read_blob(self, oid: str) -> bytes: ...
    def git_submodules(self) -> list[dict[str, object]]: ...
    def git_reflog(
        self, ref_name: str = ..., limit: int | None = ...
    ) -> list[dict[str, object]]: ...
    def git_index_entries(self) -> list[dict[str, object]]: ...
    ...
    def begin_transaction(self, ignore_immutable: bool = False) -> PyTransaction: ...
...
class PyTransaction:
    ...
    def resolve_conflict(self, path: str, content: str) -> dict[str, object]: ...
    def duplicate(
        self, revsets: list[str], onto: list[str] | None = ...
    ) -> list[dict[str, object]]: ...
    def absorb(self, source: str, into: str | None = ...) -> dict[str, object]: ...
    def fix(
        self,
        revsets: list[str],
        tools: list[str] | None = ...,
